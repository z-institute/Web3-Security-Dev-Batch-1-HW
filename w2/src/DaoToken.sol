...
contract DaoToken is ERC20("Dao Token", "DaoToken") {
    event writeCheckpoint(address delegatee);
    event moveDelegates(address currentDelegate, address delegatee, uint256 _addrBalance);
    ...
    function _delegate(address _addr, address delegatee) internal {
        ...
        emit moveDelegates( currentDelegate,  delegatee,  _addrBalance);
    }
